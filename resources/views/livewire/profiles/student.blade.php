            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center py-6">
                    <div class="flex items-center">
                        ...
                        <h1 class="ml-4 text-2xl font-bold text-zinc-900 dark:text-white">Student Profile</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="md:w-1/3 bg-gradient-to-br from-blue-500 to-purple-600 p-8 flex items-center justify-center">
                        <div class="text-center">
                            <div class="w-16 h-16 mx-auto mb-4 rounded-full bg-white/20 overflow-hidden">
                            ...
                            <div>
                                ...
                                <div class="mt-3 space-y-3">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <span class="text-zinc-900 dark:text-white">{{ $user->matric_no }}</span>
                                    </div>
                                    @endif
                                </div>
                            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-zinc-800 rounded-lg shadow-md p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h3 class="text-lg font-medium text-zinc-900 dark:text-white">Academic Status</h3>
                            <p class="text-sm text-zinc-500 dark:text-zinc-400">Active Student</p>
                        </div>
                    </div>
                </div>
